  ...
  return (
    <div className="product-container">
      ...
      <div className="flex flex-col gap-14">
        ...
        {product.isOutOfStock ? (
          <div className=" items-center gap-2 px-3 py-2 bg-[#FFF0F0] rounded-10 mx-auto w-fit flex min-w-[170px]">
            <p className="text-base font-semibold text-[#D46F77] justify-center mx-auto">
              Out-Of-Stock
            </p>
          </div>
        ) : (
